...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['business-owner', 'team-member', 'marketing-manager', 'accountant', 'end-customer'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Offers', path: '/offers', entity: 'offer', service: AccessServiceEnum.PROJECT, icon: FiPercent },
