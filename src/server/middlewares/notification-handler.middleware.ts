...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'Marketing Campaign Launched.create': {
    roles: ['business-owner', 'team-member', 'accountant'],
    key: 'marketing_campaign',
    tenantPath: [],
    userPath: [],
  },
  'Financial Report Ready.create': {
    roles: ['business-owner', 'team-member', 'marketing-manager'],
    key: 'financial_report',
    tenantPath: [],
    userPath: [],
  },
  'New Task Assigned.create': {
    roles: ['business-owner', 'marketing-manager', 'accountant'],
    key: 'task_assignment',
    tenantPath: [],
    userPath: [],
  },
...
const tenantRoles: string[] = ['business-owner', 'team-member', 'marketing-manager', 'accountant', 'end-customer'];
