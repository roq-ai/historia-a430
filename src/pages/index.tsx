  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Historia - Transforming your physical bills into structured information, enhancing your shopping experience with personalized product suggestions and exclusive offers."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1562240020-ce31ccb0fa7d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxiaWxsc3xlbnwwfHx8fDE2OTU1Mzk0MDd8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Historia - Transforming your physical bills into structured information, enhancing your shopping experience with personalized product suggestions and exclusive offers.`}
            </Text>
            <Box
